        ...
        <div className="row">
          <div className="col-lg-3 footer__first-column">
            ...
            <ul className="footer__address">
              <li>268 Elizaberth Ave Str, Brooklyn,CA, 90025</li>
              <li>+0082 561 43 34</li>
              <li><a>support@durotan.com</a></li>
            </ul>
            <ul className="footer__socials">
              <li><a target="_blank"><i className="lnil lnil-twitter"></i></a></li>
              <li><a target="_blank"><i className="lnil lnil-facebook"></i></a></li>
              <li><a target="_blank"><i className="lnil lnil-Instagram"></i></a></li>
            </ul>
          </div>
          <div className="col-lg-3 footer__second-column">
            ...
            <ul className="footer__menu">
              ...
              <li><a>Returns</a></li>
              <li><a>Gift Card</a></li>
              <li><a>Guest purchase</a></li>
              <li><a>Electronic receipt</a></li>
          ...
          <div className="col-lg-3 footer__third-column">
            ...
            <ul className="footer__menu">
              <li><a>About Durotan</a></li>
              <li><a>Contact</a></li>
              <li><a>Careers</a></li>
              <li><a>Our Journals</a></li>
            </ul>
          </div>
          <div className="col-lg-3 footer__fourth-column">
            <h6 className="footer__heading">Newsletter</h6>
            <form className="footer__newsletter">
              <div className="footer__newsletter-description">Be the first to get the latest news about trends, promotions and much more!</div>
              <input type="email" className="footer__newsleter-input" placeholder="Enter your mail address" />
              <div className="footer__newsletter-privacy-policy">By subscribing, you accept the <a href="#">Privacy Policy</a></div>
              <button type="submit" className="second-button footer__newsletter-button">Subscribe</button>
            </form>
          </div>
        </div>

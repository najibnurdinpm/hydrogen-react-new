    ...
    <div class="grid grid-cols-2 gap-4">
      <div className='py-[112px]'>
        <div className='mb-[60px]'>
          <p className='text-[#928656]'>NEW ARRIVAL</p>
        </div>
        <div className='mb-[60px]'>
          <h1 className='text-[90px]'>Basic Colours Comeback</h1>
        </div>
        <div className='mb-[112px]'>
          <p className='text-[#666666] text-[24px] pt-[35px]'>Less is more never out of date. In the last of this years, basic colours will comeback, discover our collections and choose your style</p>
        </div>
        <div className=''>
          <div class="flex">
            <div class="mr-[30px] py-[20px]">
              <a href="" className='bg-[#928656] py-[20px] px-[38px] text-white'>
                SHOP NOW
              </a>
            </div>
            <div class="">
              <div className='flex'>
                <div className='border-4 border-bg-[#928656] w-[70px] h-[70px] rounded-full'>
                  
                </div>
                <div className='ml-2 text-[#928656]'>
                  VEIW <div> LOOKBOOK</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className='w-[100%] bg-[#4b5329] h-[886px]'>09</div>
    </div>

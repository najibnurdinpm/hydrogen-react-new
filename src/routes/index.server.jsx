  ...
  return (
    ...
    <div className="container container--type-2">
      <div className="container">
        <h4 className="featured-collections__title">Featured Collections</h4>
        <div className="featured-collections__description">New arrivals, best seling or any discount programs, click on any collection that you’re looking for</div>
      </div>  
      <div className="row">
